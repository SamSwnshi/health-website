...
const Dashboard = () => {
  ...
  const handleDelete = async (appointmentId) => {
    try {
      ...
      setAppointments((app) => app.filter((appointment) => appointment._id !== appointmentId));
          ...
          <div className="flex flex-1 items-center bg-blue-200 rounded-lg p-5">
            <div className="flex-2 ml-4 md:md-0">
              ...
              <p className="text-sm md:text-base">
                Welcome to the admin Dashboard <div className="br"></div> Here
                You can message all the appointments and doctors
              </p>
            </div>
          </div>
          <div
